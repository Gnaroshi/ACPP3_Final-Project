    ...
    with st.container(key="project_overview"):
        st.markdown(
            ...
            <section class="rr-project-overview" aria-label="RebootRoute 설명">
              <div class="rr-project-copy">
                <h2>흩어진 인천 공식 정보를 오늘 할 수 있는 순서로 정리합니다</h2>
                <p>RebootRoute는 인천 청년정책, 청년공간, 문화행사, 프로그램 정보를 먼저 보여주고 사용자가 지금 가능한 시간과 대면 부담, 비용 조건을 고르면 오늘 확인할 자료와 10~20분 안에 끝낼 작은 행동을 연결합니다.</p>
              </div>
