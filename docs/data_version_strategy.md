...
- fetcher/parser: `src/rebootroute/data/official_sources.py`
- audit report: `reports/resource_audit.md`

Synthetic MVP mock data:
...
profile/progress/outcome은 실제 사용자를 나타내지 않는 mock dataset입니다. 현재 기본 profile 생성 규모는 1000명입니다.
...
- 공식 HTML 수집 resource -> 공식 API/기관 제공 파일/운영자가 검수한 최신 resource table
