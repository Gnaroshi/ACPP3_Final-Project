...
- 선택 완료 후 먼저 보이는 오늘 할 미션 카드
- 그 아래 desktop 2열, mobile 1열로 정렬되는 공식 자료 카드와 지도 카드
...
사용자는 먼저 네 가지 선택지를 고릅니다. 네 조건이 모두 선택되기 전에는 추천 결과를 확정해서 보여주지 않습니다. 조건을 바꾸면 추천 미션, 자원 후보, 지도 위치가 즉시 다시 계산됩니다. 별도의 업데이트 버튼이나 재추천 버튼을 누르지 않습니다.
